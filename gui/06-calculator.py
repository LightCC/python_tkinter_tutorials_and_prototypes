...
button_add = Button(root, text='+', padx=39, pady=20, command=button_add_click)
button_equal = Button(root, text='=', padx=88, pady=20, command=button_equal_click)
button_clear = Button(root, text='Clear', padx=78, pady=20, command=button_clear_click)

button_subtract = Button(root, text='-', padx=41, pady=20, command=button_subtract_click)
button_multiply = Button(root, text='*', padx=40, pady=20, command=button_multiply_click)
button_divide = Button(root, text='/', padx=40, pady=20, command=button_divide_click)
